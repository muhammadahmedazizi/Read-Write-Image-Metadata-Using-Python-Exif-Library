# Resource Link : https://github.com/kennethleungty/Image-Metadata-Exif/blob/main/batch_process_metadata.py

# Code copied for understanding and experiment only. Temporary File
